        ...
        <div class="container-fluid py-4 px-0">
            <div class="card">
                ...
                <div class="card-body pt-4 p-3">
                    <form action="{{ route('servicios.store') }}" method="POST" role="form text-left">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="@error('nombre') border border-danger rounded-3 @enderror">
                                        <input class="form-control" type="text" placeholder="Nombre" id="servicio-nombre"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="@error('precio') border border-danger rounded-3 @enderror">
                                        <input class="form-control" type="number" step="0.01" placeholder="Precio"
                                            id="servicio-precio" name="precio" required>
                                        @error('precio')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="@error('descripcion') border border-danger rounded-3 @enderror">
                                        <input class="form-control" type="text" placeholder="Descripción"
                                            id="servicio-descripcion" name="descripcion" required>
                                        @error('descripcion')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                    </div>
