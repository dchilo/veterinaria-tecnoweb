...
@section('content')
        ...
        <div class="container-fluid py-4 px-0">
            <div class="card">
                ...
                <div class="card-body pt-4 p-3">
                    <form action="{{ route('proveedores.store') }}" method="POST" role="form text-left">
                        @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="@error('proveedor.nombre')border border-danger rounded-3 @enderror">
                                        <input class="form-control" type="text" placeholder="Nombre"
                                            id="proveedor-nombre" name="nombre" required>
                                        @error('nombre')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="@error('email')border border-danger rounded-3 @enderror">
                                        <input class="form-control" type="email" placeholder="@example.com"
                                            id="proveedor-email" name="email" required>
                                        @error('email')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="@error('proveedor.telefono')border border-danger rounded-3 @enderror">
                                        <input class="form-control" type="tel" placeholder="Teléfono"
                                            id="proveedor-telefono" name="telefono">
                                        @error('telefono')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="@error('proveedor.direccion')border border-danger rounded-3 @enderror">
                                        <input class="form-control" type="text" placeholder="Dirección"
                                            id="proveedor-direccion" name="direccion" required>
                                        @error('direccion')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#proveedor-telefono').on('input', function() {
