    ...
    <div>
        ...
        <div class="d-flex justify-content-between mb-4" style="margin-right: 8px; position: relative;">
            ...
            <div class="mt-4 mb-3" style="position: absolute; top: 8px; right: 0;">
                <a href="{{ route('proveedores.create') }}" class="btn bg-gradient-dark btn-md">Nuevo</a>
                <a href="{{ route('proveedores.generatePDF') }}" class="btn bg-gradient-dark btn-md">PDF</a>
            </div>
        </div>
                ...
                <div class="card mb-4 mx-0">
                    ...
                    <div class="card-body" style="padding: 1rem">
                        <div class="table-responsive p-0">
                            <table id="proveedoresTable" class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($proveedores as $proveedor)
                                        <tr>
                                            <td class="ps-4">
                                                <p class="text-xs font-weight-bold mb-0">{{ $proveedor->id }}</p>
                                            </td>
                                            ...
                                            <td class=" text-center">
                                                ...
                                                <form action="{{ route('proveedores.destroy', $proveedor) }}"
                                                    ...
                                                    <a href="{{ route('proveedores.edit', $proveedor->id) }}"
                                                        ...
                                                        data-bs-original-title="Editar proveedor">
                                                        <i class="fas fa-pencil-alt text-secondary"></i>
                                                    </a>

                                                    {{-- <a href="{{ route('proveedores.show', $proveedor->id) }}"
                                                        class="mx-3 text-white" data-bs-toggle="tooltip"
                                                        data-bs-original-title="Ver proveedor">
                                                        <i class="fas fa-eye text-secondary"></i>
                                                    </a> --}}

                                                    <button type="submit" class="cursor-pointer"
                                                        style="border: none; background: none;"
                                                        onclick="return confirm('¿Está seguro de que desea borrar este proveedor?');">
