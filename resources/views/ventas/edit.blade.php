        ...
        <div class="container-fluid py-4 px-0">
            <div class="card">
                ...
                <div class="card-body pt-4 p-3">
                    <form action="{{ route('ventas.update', $venta->id) }}" method="POST" role="form text-left">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="number" placeholder="Cantidad" id="venta-cantidad" name="cantidad" value="{{ $venta->cantidad }}" required>
                                    @error('cantidad')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="date" id="venta-fecha" name="fecha" value="{{ $venta->fecha }}" required>
                                    @error('fecha')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" step="0.01" placeholder="Total" id="venta-total" name="total" value="{{ $venta->total }}" required>
                            @error('total')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                            @enderror
                        </div>
