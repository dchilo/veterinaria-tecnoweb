    ...
    <div>
        <div class="d-flex justify-content-between mb-4" style="margin-right: 8px; position: relative;">
            ...
            <div class="mt-4 mb-3" style="position: absolute; top: 8px; right: 0;">
                <a href="{{ route('ventas.create') }}" class="btn bg-gradient-dark btn-md mr-2">Nueva Venta</a>
            </div>
        </div>
                ...
                <div class="card mb-4 mx-0">
                    ...
                    <div class="card-body" style="padding: 1rem">
                        <div class="table-responsive p-0">
                            <table id="ventasTable" class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    @foreach ($ventas as $venta)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <p class="text-xs font-weight-bold mb-0">{{ $venta->producto->nombre }}</p>
                                            </td>
                                            <td class="text-center">
                                                <p class="text-xs font-weight-bold mb-0">{{ $venta->cantidad }}</p>
                                            </td>
                                            <td class="text-center">
                                                <span class="text-xs font-weight-bold">{{ \Carbon\Carbon::parse($venta->fecha)->format('d-m-Y') }}</span>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <form action="{{ route('ventas.destroy', $venta) }}" method="post">
                                                    ...
                                                    <a href="{{ route('ventas.show', $venta->id) }}" class="text-white" data-bs-toggle="tooltip" data-bs-original-title="Ver Venta">
                                                        <i class="fas fa-eye text-secondary"></i>
                                                    </a>

                                                    <a href="{{ route('ventas.edit', $venta->id) }}" class="mx-3 text-white" data-bs-toggle="tooltip" data-bs-original-title="Editar Venta">
                                                        <i class="fas fa-user-edit text-secondary"></i>
                                                    </a>

                                                    <button type="submit" class="cursor-pointer" style="border: none; background: none;" onclick="return confirm('¿Está seguro de que desea borrar esta venta?');">
