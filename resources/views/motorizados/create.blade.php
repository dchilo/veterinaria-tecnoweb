...
@section('content')
    <div>
        <div class="d-flex justify-content-between mb-2" style="margin-right: 6px; position: relative; ">
            <div class="col-xl-3 col-sm-4 " style="width: 24rem;">
                <div class="card">
                            ...
                            <div class="col-1 align-content-center">
                                <a href="{{ route('motorizados.index') }}" class="text-decoration-none">
                                    <div class="icon text-center border-radius-md icon-sm text-secondary"
                                        ...
                                        <i class="fas fa-arrow-left text-xs opacity-10 mt-2 text-secondary"
                                            aria-hidden="true" style="margin: 0 auto;"></i>
                                    </div>
                                </a>
                            </div>
                            <div class="col-7">
        ...
        <div class="container-fluid py-4 px-0">
            <div class="card">
                ...
                <div class="card-body pt-4 p-3">
                    <form action="{{ route('motorizados.store') }}" method="POST" role="form text-left">
                        @csrf
                        ...
                        <div class="row">
                            @if (Auth::user()->rol == 'tipo_usuario' || Auth::user()->tipo_usuario == 'Técnico')
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="motorizado-cliente" class="form-control-label">Cliente</label>
                                        <div
                                            class="@error('motorizado.cliente_id')border border-danger rounded-3 @enderror">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="@error('motorizado.modelo')border border-danger rounded-3 @enderror">
                                        <input class="form-control" type="text" placeholder="Modelo"
                                            id="motorizado-modelo" name="modelo" required>
                                        @error('modelo')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="@error('motorizado.anio')border border-danger rounded-3 @enderror">
                                        <input class="form-control" type="number" placeholder="Año"
                                            id="motorizado-anio" name="anio" min="1885" max="9999" required>
                                        @error('anio')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="@error('motorizado.placa')border border-danger rounded-3 @enderror">
                                        <input class="form-control" type="text" placeholder="Placa"
                                            id="motorizado-placa" name="placa" required>
                                        @error('placa')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="@error('motorizado.estado')border border-danger rounded-3 @enderror">
                                            <input class="form-control" type="text" placeholder="Estado"
                                                id="motorizado-estado" name="estado" value="Activo" hidden>
                                            @error('estado')
                                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
