<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3" id="sidenav-main" style="height: 100vh; overflow-y: auto;">
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            <img src="{{ asset('assets/images/logo.png') }}" class="navbar-brand-img border-radius-md" style="height: 150" alt="...">
            <span class="ms-3 font-weight-bold">VETERINARIA EL CAMPO</span>
        </a>
    </div>
    <hr class="horizontal dark mt-0">
    <div class="navbar" style="box-shadow: none">
        <ul class="navbar-nav" style="max-height: 100rem">
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link {{ (Request::is('perfil') ? 'active' : '') }}" href="{{ route('perfil.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ (Request::is('inventarios') ? 'active' : '') }}" href="{{ route('inventarios.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-boxes text-sm opacity-10" style="color: #1d365d;"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ (Request::is('ventas') ? 'active' : '') }}" href="{{ route('ventas.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-shopping-cart text-sm opacity-10" style="color: #1d365d;"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ (Request::is('productos') ? 'active' : '') }}" href="{{ route('productos.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-box text-sm opacity-10" style="color: #1d365d;"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ (Request::is('servicios') ? 'active' : '') }}" href="{{ route('servicios.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-stethoscope text-sm opacity-10" style="color: #1d365d;"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ (Request::is('promociones') ? 'active' : '') }}" href="{{ route('promociones.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-tags text-sm opacity-10" style="color: #1d365d;"></i>
                    </div>
            ...
            <li class="nav-item pb-5">
                <a class="nav-link {{ (Request::is('pagos') ? 'active' : '') }}" href="{{ route('pagos.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="far fa-money-bill-alt text-sm opacity-10" style="color: #1d365d;"></i>
                    </div>
