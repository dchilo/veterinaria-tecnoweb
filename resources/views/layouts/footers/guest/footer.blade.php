          ...
          <a href="https://www.creative-tim.com/support-terms" target="_blank" class="text-secondary me-xl-5 me-3 mb-sm-0 mb-2">
              ...
              @if (!auth()->user() || \Request::is('static-sign-up'))
                  <div class="col-lg-8 mx-auto text-center mb-4 mt-2">
                      ...
                      <a href="https://github.com/LESALOMEE" target="_blank" class="text-secondary me-xl-4 me-4">
              ...
              <div class="row">
                  <div class="col-8 mx-auto text-center mt-1">
                      <p class="mb-0 text-secondary">
                          ...
                          <a style="color: #252f40;" href="https://github.com/LESALOMEE" class="font-weight-bold ml-1"
                              target="_blank">TecnoWeb Grupo 09</a>
                      </p>
                  </div>
              </div>
          @endif
