    ...
    <div>
        <div class="d-flex justify-content-between mb-2" style="margin-right: 8px; position: relative;">
            ...
            <div class="mt-4 mb-3" style="position: absolute; top: 8px; right: 0;">
                <a href="{{ route('promociones.create') }}" class="btn bg-gradient-dark btn-md mr-2">Nuevo</a>
                <a href="{{ route('promociones.generatePDF') }}" class="btn bg-gradient-dark btn-md">PDF</a>
            </div>
        </div>
                ...
                <div class="card mb-4 mx-0">
                    ...
                    <div class="card-body" style="padding: 1rem">
                        <div class="table-responsive p-0">
                            <table id="promocionesTable" class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    @foreach ($promociones as $promocion)
                                        <tr>
                                            <td class="ps-4">
                                                <p class="text-xs font-weight-bold mb-0">{{ $promocion->id }}</p>
                                            </td>
                                            <td class="text-center">
                                                <p class="text-xs font-weight-bold mb-0">{{ $promocion->producto->nombre }}</p>
                                            </td>
                                            <td class="text-center">
                                                <p class="text-xs font-weight-bold mb-0">{{ $promocion->nombre }}</p>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <form action="{{ route('promociones.destroy', $promocion) }}" method="post">
                                                    ...
                                                    <a href="{{ route('promociones.edit', $promocion->id) }}" class="text-white" data-bs-toggle="tooltip" data-bs-original-title="Editar promoción">
                                                        <i class="fas fa-user-edit text-secondary"></i>
                                                    </a>

                                                    <a href="{{ route('promociones.show', $promocion->id) }}" class="mx-3 text-white" data-bs-toggle="tooltip" data-bs-original-title="Ver promoción">
                                                        <i class="fas fa-eye text-secondary"></i>
                                                    </a>

                                                    <button type="submit" class="cursor-pointer" style="border: none; background: none;" onclick="return confirm('¿Está seguro de que desea borrar esta promoción?');">
