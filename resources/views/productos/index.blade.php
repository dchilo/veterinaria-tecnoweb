    ...
    <div>
        <div class="d-flex justify-content-between mb-2" style="margin-right: 8px; position: relative;">
            ...
            <div class="mt-4 mb-3" style="position: absolute; top: 8px; right: 0;">
                <a href="{{ route('productos.create') }}" class="btn bg-gradient-dark btn-md mr-2">Nuevo</a>
                <a href="{{ route('productos.generatePDF') }}" class="btn bg-gradient-dark btn-md">PDF</a>
            </div>
        </div>
                                ...
                                <tbody>
                                    @foreach ($productos as $producto)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <p class="text-xs font-weight-bold mb-0">{{ $producto->proveedor_nombre }}</p>
                                            </td>
                                            <td class="text-center">
                                                <form action="{{ route('productos.destroy', $producto) }}" method="post">
                                                    ...
                                                    <a href="{{ route('productos.edit', $producto->id) }}" class="text-white" data-bs-toggle="tooltip" data-bs-original-title="Editar producto">
                                                        <i class="fas fa-user-edit text-secondary"></i>
                                                    </a>

                                                    <a href="{{ route('productos.show', $producto->id) }}" class="mx-3 text-white" data-bs-toggle="tooltip" data-bs-original-title="Ver producto">
                                                        <i class="fas fa-eye text-secondary"></i>
                                                    </a>

                                                    <button type="submit" class="cursor-pointer" style="border: none; background: none;" onclick="return confirm('¿Está seguro de que desea borrar este producto?');">
